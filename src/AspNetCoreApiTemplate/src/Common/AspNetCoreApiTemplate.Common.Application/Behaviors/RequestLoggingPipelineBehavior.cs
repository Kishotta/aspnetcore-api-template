...
namespace AspNetCoreApiTemplate.Common.Application.Behaviors;
    ...
    where TResponse : Result
{
    ...
    /// </summary>
    /// <remarks>
    /// Module commands are conventionally in project: "AspNetCoreApiTemplate.Modules.[Module].Application"
    /// </remarks>
