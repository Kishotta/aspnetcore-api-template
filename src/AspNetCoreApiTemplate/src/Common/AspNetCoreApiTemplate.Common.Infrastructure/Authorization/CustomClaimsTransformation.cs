...
using AspNetCoreApiTemplate.Common.Application.Authorization;
using AspNetCoreApiTemplate.Common.Application.Exceptions;
using AspNetCoreApiTemplate.Common.Infrastructure.Authentication;
    ...
    : IClaimsTransformation
{
    public async Task<ClaimsPrincipal> TransformAsync(ClaimsPrincipal principal)
    {
        ...
        if (result.IsFailure)
            throw new AspNetCoreApiTemplateException(nameof(IPermissionService.GetUserPermissionsAsync), result.Error);
